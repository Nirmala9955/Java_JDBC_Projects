...
public class CS_MultipleTestUsingPL_SQLProcedure {
	
	private static final String CALL_MULTI_PROCEDURE = "{CALL P_MULTI(?,?,?)}";
	public static void main(String[] args) {
		...
		try {
			...
			if(con!=null) {
				cs = con.prepareCall(CALL_MULTI_PROCEDURE);
			}
			if(cs!=null) {
				...
				result=cs.getInt(3);
				System.out.print("Multi is : "+result); 
			}
		} //try
